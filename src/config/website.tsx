...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/experienceabstraction/media/official-3.png',
      logoLight: '/experienceabstraction/icon.png',
      logoDark: '/experienceabstraction/icon.png',
    },
    social: {
      github: '',
      twitter: '',
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Experience Abstraction Wiki <hello@experienceabstraction.wiki>',
    supportEmail: 'hello@experienceabstraction.wiki',
  },
  newsletter: {
    enable: false,
    provider: 'resend',
