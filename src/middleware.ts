...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/play\/?$/, target: '/official-links' },
  { pattern: /^\/how-to-abstract\/?$/, target: '/guides/how-to-abstract' },
  {
    pattern: /^\/avoid-abstraction\/?$/,
    target: '/guides/how-to-avoid-abstraction',
  },
  {
    pattern: /^\/experience-abstraction-roblox\/?$/,
    target: '/official-links',
  },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set([
    'experienceabstraction.wiki',
    'www.experienceabstraction.wiki',
  ]);
  const canonicalHost = 'www.experienceabstraction.wiki';
