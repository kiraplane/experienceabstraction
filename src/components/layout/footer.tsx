...
export function Footer({ className }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <footer
      className={cn(
        'border-fuchsia-300/15 border-t bg-[#06040D] text-white',
        className
      )}
    >
                ...
                <div className="flex items-center gap-2">
                  {socialLinks?.map((link) => (
                    <a
                      ...
                      className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-fuchsia-300/15 text-slate-400 hover:border-cyan-300/40 hover:bg-cyan-300/5 hover:text-white"
                    >
                      ...
                      <li key={item.title}>
                        {item.isImage ? (
                          ...
                          <LocaleLink
                            ...
                            title={item.linkTitle}
                            className={cn(
                              'text-sm text-slate-400 hover:text-cyan-300',
      ...
      <div className="border-fuchsia-300/15 border-t py-8">
        <Container className="px-4 flex items-center justify-between gap-x-4">
          ...
          <span className="text-slate-400 text-sm">
            Independent guide site. Not affiliated with Roblox, pawlooz, or
            GLITCH.
          </span>
        </Container>
      </div>
