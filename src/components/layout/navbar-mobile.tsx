        ...
        <div className="flex items-center justify-end gap-4">
          <Button
            ...
            className="size-8 flex aspect-square h-fit cursor-pointer select-none items-center
              justify-center rounded-md border border-fuchsia-300/20 text-white"
          >
            {open ? (
...
function MainMobileMenu({ onLinkClicked }: MainMobileMenuProps) {
  ...
  return (
    <div
      ...
      border-fuchsia-300/15 border-t bg-[#090713] text-foreground backdrop-blur-md animate-in fade-in-0"
    >
