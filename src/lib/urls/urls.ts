...
export const CANONICAL_BASE_URL = 'https://www.experienceabstraction.wiki';
...
function getExperienceAbstractionBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'experienceabstraction.wiki' ||
      parsedUrl.hostname === 'www.experienceabstraction.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const experienceAbstractionBaseUrl =
    getExperienceAbstractionBaseUrl(configuredBaseUrl);
  if (experienceAbstractionBaseUrl) {
    return experienceAbstractionBaseUrl;
  }
