        ...
        <FaqSection
          ...
          items={[
            ...
            },
            {
              ...
              answer:
                'No reliable code mechanic or active code source was verified, so the launch site does not create a speculative codes page.',
            },
            {
              question: 'Why are there only three guides?',
              answer:
                'The game is new and its reliable data surface is still thin. Each launch guide targets a supported search intent instead of padding the site with empty databases.',
            },
          ]}
        />
      </Container>
